...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath 
{
    ...
    switch( [indexPath indexAtPosition:1] ) // index pos 1, not zero, only 
      {
      case 0 : 
	...
	break;
      case 1 : 
	people = [mySession objectForKey:@"people"];
	if( people && [people count] > 0)
	  {
	    cell.textLabel.text = @"Presetor";
	    cell.detailTextLabel.text = 
	      [[[mySession objectForKey:@"people"] objectAtIndex:0] objectForKey:@"individual"];
