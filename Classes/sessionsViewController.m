		...
		switch ([indexPath indexAtPosition:0]) // switch for which section
		{
				...
				switch ([indexPath indexAtPosition:1]) // switch by position within section 0 ("All" )
			{
				...
				case 2 : 
					...
					cell.textLabel.text = @"Remote Office";
					cell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;	
					break;
					// TODO default :  assert  at defaults? 
			}
				break;
			case 1 : 
			...
			{
				case 0 :
					cell.textLabel.text = @"Call Forwarding";
					cell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;	
					break;
				case 1 : 
					cell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;	
					cell.textLabel.text = @"Call Notify";
					break;
				case 2 : 
					cell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;	
					cell.textLabel.text = @"Sequential Ring";
					break;
			}
				break; 
